"""BDDGameState - the main game state class for BDD tests."""
...
from tests.bdd_helpers.core import (
    TestZone, TestAttack, TestPlayer, PlayResult, DefendResult, LegalPlay, RestrictionCheck,
)
from tests.bdd_helpers.stubs import (
    LastKnownInformationStub, ModificationResultStub, TargetingResultStub,
    AttackProxyStub, SourceValidationResultStub, PreventionEffectStub,
    ActivatedLayerStub, TriggeredLayerStub, ResolutionResultStub,
    ModalModeResultStub, ConnectedAbilityPairResultStub, AbilityModificationResultStub,
    DamageEffectStub, OptionalEffectStub, OptionalEffectResultStub,
    MultiTargetEffectStub, EffectResolutionResultStub,
    AssetSpendResultStub, ChiPaymentResultStub, LifeGainResultStub, LifeCostAbilityStub,
    MultiAssetAbilityStub, EffectCostAbilityStub, TwoEffectCostAbilityStub,
    PitchInstructionEffectStub, PitchTriggerEffectStub, PitchReplacementEffectStub,
    GeneralReplacementEffectStub, CostReductionEffectStub,
    AssetPaymentResultStub, MultiAssetPaymentResultStub, CardPlayResultStub,
    AbilityActivationResultStub, FullCostStub, PitchPaymentResultStub,
    PitchAttemptResultStub, ChiCostPaymentResultStub, ResourceCostPaymentResultStub,
